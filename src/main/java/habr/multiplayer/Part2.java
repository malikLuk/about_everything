 ...
 * scheme_2_4.gif. Статься рассказывает, как нам стыковаться с другими игроками. Экстраполяция - предсказывает положение других игроков в
 * пространстве на основе прошлой информации. Интерполяция - ничего не предсказывает, а использует только реальную информацию, предоставленную
 * сервером, показывая других игроков из недавнего прошлого. Игрок же всегда видит себя в настоящем.
 *
 * */
