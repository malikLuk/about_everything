 ...
 *  - USER_ENTER_EVENT (default true). Уведомление о присоединении. Отключение приведет к нарушению правильной работы личных и публичных
 *      сообщений. Но общение через список друзей будет работать.
 *  - USER_EXIT_EVENT (default true). Уведомление о выходе из Комнаты. Отключение приведет к нарушению правильной работы личных и публичных
 *      сообщений. Но общение через список друзей будет работать.
