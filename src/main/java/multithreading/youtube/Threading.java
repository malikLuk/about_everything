 ...
 * Вытесняющая - это вид многозадачности при которой ОС сама принимает решение о переключении между задачами по истечении
 ...
 * работающих приложений, благодаря чему, зависшие или зациклившиеся приложения не вешают ОС. Именно Вытесняющая модель
...
public class Threading {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        /**
         * Используем блокировщик.
         * Никакой информации не потеряется, но
